...
Page({
  ...
  searchFilm:function(options){
//    console.log(options.detail.value);
    var v = options.detail.value;
    var startN = 0;
    var loadN = 0;
    var countN = 20;
    var url = app.globalData.doubanBase + app.globalData.search+v;
    var _this=this;
    wx.request({
  ...
  onReachBottom: function () {
    ...
    var filmCom = app.globalData.doubanBase + app.globalData.search + v+ "?start=" + startN + "&count=" + countN;
    const _this = this;
    wx.showToast({
      title: '加载中',
      icon: 'loading',
